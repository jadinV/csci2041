...
let () = assert (expr_has_type (Lte ((Mul ((Lit (Int 285)), (Lit (Bool false)))), (Lte ((Add ((Lit (Int 370)), (Lit (Bool true)))), (Lit (Int (-1))))))) BoolTy = false)
...
let () = assert (expr_has_type (If (Lit (Bool false), Mul ((Lit (Int 285)), (Lit (Bool false))), Lit (Bool true))) BoolTy = false)
